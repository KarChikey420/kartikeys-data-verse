...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { label: "Resume", href: "https://drive.google.com/file/d/1Bp4C-O9_HrkFpFU1jnD2L5gQt8ZUH2Z_/view?usp=sharing", icon: <FileText className="w-4 h-4 inline-block ml-1" /> }, // 👈 Resume
  ];
